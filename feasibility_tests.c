...
// U=0.7333
U32_T ex0_period[] = {3, 5, 15};
U32_T ex0_wcet[] = {1, 2, 3};

// U=0.9857
U32_T ex1_period[] = {3, 5, 15};
U32_T ex1_wcet[] = {1, 2, 4};

// U=0.9967
U32_T ex2_period[] = {6, 8, 12, 24};
U32_T ex2_wcet[] = {1, 2, 4, 6};

// U=0.93
U32_T ex3_period[] = {2, 4, 8};
U32_T ex3_wcet[] = {1, 1, 2};
...
{ 
    ...
    printf("Ex-0 U=%4.2f (C1=1, C2=2, C3=3; T1=3, T2=5, T3=15; T=D): ",
    ...
    printf("Ex-1 U=%4.2f (C1=1, C2=2, C3=4; T1=3, T2=5, T3=15; T=D): ", 
    ...
    printf("Ex-2 U=%4.2f (C1=1, C2=2, C3=4, C4=6; T1=6, T2=8, T3=12, T4=24; T=D): ",
    ...
    printf("Ex-3 U=%4.2f (C1=1, C2=1, C3=2; T1=2, T2=4, T3=8; T=D): ",
    ...
    printf("Ex-4 U=%4.2f (C1=1, C2=1, C3=1, C4 =2; T1=2, T2=5, T3=7, T4=13; T=D): ",
